...
class App extends Component {
  state = {
    ...
    selected: 0,
    filesList: [
      { id: 0, doc: 'document1', disName: 'Document 01' },
      {
        id: 1,
        doc: 'document2',
        disName: 'Document 02',
    ...
    return (
      <div className={'container'}>
        <SideDrawer
          ...
          selected={selected}
          filesList={filesList}
          onSelectDoc={id => this.onSelectDoc(id)}
        ...
        <div className={'container-right'}>
          <button className={'menuOpen'} onClick={() => this.setState({ show: true })}>
            open menu
          </button>
          <Text addStyle={{ textAlign: 'left' }} type={'heading'}>
            <img src={'/images/docLarge.png'} />
            {filesList[selected].disName}
          </Text>
          <RenderPdf
            file={file}
